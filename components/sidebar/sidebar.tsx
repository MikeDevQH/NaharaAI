...
export function Sidebar({ className, isOpen, setIsOpen }: SidebarProps) {
  ...
  return (
    <div
      className={cn(
        "flex flex-col bg-gradient-to-br from-indigo-900/95 to-blue-950/90 backdrop-blur-md border-r border-blue-800 transition-all duration-300",
        isOpen ? "w-72" : "w-0",
        className
      )}
    >
      {isOpen && (
        <>
          ...
          <div className="p-4 border-b border-blue-800 bg-transparent text-white">
            ...
            <h2 className="text-sm font-medium mb-3 uppercase tracking-wider opacity-80">
              Conversations
            </h2>
            <Button
                  ...
                  <motion.div
                    ...
                    className={cn(
                      ...
                      currentConversation?.id === conversation.id
                        ? "bg-blue-900/50 border-blue-700 shadow-sm"
                        : ""
                    )}
                  >
                    {editingId === conversation.id ? (
                      ...
                      >
                        <div className="text-sm font-medium text-blue-300 truncate pr-16">
                          {conversation.title}
                        </div>
